...
THREE.GPUParticleSystem = function(options) {
  ...
  self.particleNoiseTex = THREE.ImageUtils.loadTexture(root_folder+"threejs/"+"textures/perlin-512.png");
  self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

  self.particleSpriteTex = THREE.ImageUtils.loadTexture(root_folder+"threejs/"+"textures/particle2.png");
