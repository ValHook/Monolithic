...
THREEx.MD2CharacterRatmahatta	= function(onLoad){
	...
	this.setSkinName= function(skinName){
		if (skinName == "ghost") {
			...
			character.meshBody.material.transparent = true;
			character.meshWeapon.material.transparent = true;
			character.meshBody.material.opacity = 0.2;
			character.meshWeapon.material.opacity = 0.2;
			return;
		}
...
THREEx.MD2CharacterRatmahatta.baseUrl	= root_folder;
