...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
			...
			.emailButton{background-color:#FF5766; border-collapse:separate; border-radius:4px;}
			.buttonContent{color:#FFFFFF; font-family:Helvetica; font-size:18px; font-weight:bold; line-height:100%; padding:15px; text-align:center;}
			.buttonContent a{color:#FFFFFF; display:block; text-decoration:none;}
			.emailCalendar{background-color:#FFFFFF; border:1px solid #CCCCCC;}
			.emailCalendarMonth{background-color:#FF5766; color:#FFFFFF; font-family:Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold; padding-top:10px; padding-bottom:10px; text-align:center;}
			.emailCalendarDay{color:#FF5766; font-family:Helvetica, Arial, sans-serif; font-size:60px; font-weight:bold; line-height:100%; padding-top:20px; padding-bottom:20px; text-align:center;}
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        <h3>WebArena Monolithic</h3>
                                                                        <br />
                                                                        <?php if ($fgPSW) { ?> 
                                                                        	Vous avez oublié votre mot de passe? <br> Pas de problème, vous pouvez en configurer un nouveau! Cliquez sur configurer un mote de passe. Votre code de sécurité est : <?php echo($valueMDP);?> 
                                                                        <?php } else { ?>
                                                                        	Bienvenu sur Monolithic. <br> Entrez dans l'arène et venez défier vos amies.
                                                                        <?php }?>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="260" class="emailButton">
                                                                <tr>
                                                                    <td align="center" valign="middle" class="buttonContent">
	                                                                    <?php if ($fgPSW) { ?> 
                                                                        	<a href="<?php echo($urlReInit);?> " target="_blank">Configurer nouveau mot de passe</a>
                                                                        <?php } else { ?>
                                                                        	<a href="http://www.monolithic.fr/joueurs/connexion" target="_blank">Jouer!</a>
                                                                         <?php } ?>
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td valign="top" class="imageContent">
                                                                                    <img src="http://www.monolithic.fr/img/mailPhoto-min.png" width="520" class="flexibleImage" style="max-width:520px;" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                    <h3>Monolithic</h3>
                                                                                    <br />
                                                                                   Bienvenu sur Monolithic.
Il s’agit d’un jeux en ligne permettant à un joueur d’affronter d’autres joueurs dans une arène conçu à cet effet. Tuez des combattants, amassez de l’expérience, accumulez de l’équipement et de devenez le roi des arènes.
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- // CONTENT TABLE -->
                                                                        ...
                                                                        <table align="Right" border="0" cellpadding="0" cellspacing="0" width="320" class="flexibleContainer">
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                    <h3>Guerre</h3>
                                                                                    <br />
                                                                                    Rendez-vous le 3 Décembre 2015 pour une grosse guerre entre tous les joueurs de monolithic, que la force soit avec toi!
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- // CONTENT TABLE -->
