...
<body>
	...
	(function () {
		...
		setInterval(function(){
			...
			if (nuit || 1) {
				// NUIT
				scene.fog = new THREE.FogExp2( 0xff0000, 0.06 );
	...
	var worldWidth = 150, worldDepth = 250;
	var cubeSize = 50;
	var mapScale = 0.0033;
	...
	(function() {
		// Brouillard
		scene.fog = new THREE.FogExp2( 0xff0000, 0.08 );
		...
		/* Texture & Matériau */
		var texture = THREE.ImageUtils.loadTexture( '<?php echo (ROOT_FOLDER.'js/3d/threejs/textures/minecraft/roche.png'); ?>' );
		...
		var glassTexture = THREE.ImageUtils.loadTexture( '<?php echo (ROOT_FOLDER.'js/3d/threejs/textures/minecraft/lave.png'); ?>' );
...
*/
	...
	function generateHeight( width, height ) {
		...
		size = width * height, quality = 2, z = 789;
