...
<body>
	...
	var worldWidth = 120, worldDepth = 120;
	var cubeSize = 100;
	var mapScale = 0.0033;
	...
	(function() {
		...
		/* Texture & Matériau */
		var texture = THREE.ImageUtils.loadTexture( '<?php echo (ROOT_FOLDER.'js/3d/threejs/textures/minecraft/herbe.png'); ?>' );
...
*/
	...
	function generateHeight( width, height ) {
		...
		size = width * height, quality = 2, z = 28;
