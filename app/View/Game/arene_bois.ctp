...
<body>
	...
	var worldWidth = 90, worldDepth = 90;
	var cubeSize = 100;
	var mapScale = 0.0033;
	...
	(function() {
		...
		/* Texture & Matériau */
		var texture = THREE.ImageUtils.loadTexture( '<?php echo (ROOT_FOLDER.'js/3d/threejs/textures/minecraft/bois.png'); ?>' );
...
*/
	...
	function generateHeight( width, height ) {
		...
		size = width * height, quality = 2, z = 400;
